...
const Showreels = () => {
  ...
  <div className="showreel-swiper-wrapper">
    <div ref={prevRef} className="showreels-custom-button showreels-custom-prev"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
  <path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/>
</svg></div>
  <div ref={nextRef} className="showreels-custom-button showreels-custom-next"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
